      ...
      describe ':tag_helpers opts' do
        ...
        describe 'custom settings' do
          ...
          it 'should set :tags_label_required_str to "REQUIRED" the custom settings' do
            _(@b.tag_helpers_opts[:tags_label_required_str]).must_equal "REQUIRED"
          end
      
          it 'should set :tags_forms_default_class to "form-control" the custom settings' do
            _(@b.tag_helpers_opts[:tags_forms_default_class]).must_equal "form-control"
          end
        ...
        describe 'double loading of plugin' do
          ...
          it 'should have the custom settings' do
            _(@c.tags_opts[:orig_opts]).must_equal({
              tag_output_format_is_xhtml:   false, 
              tag_add_newlines_after_tags:  true, 
              tags_label_required_str:      "REQUIRED", 
              tags_label_append_str:        ":"
            })
            _(@d.tags_opts[:orig_opts]).must_equal({
              tag_output_format_is_xhtml:   false, 
              tag_add_newlines_after_tags:  true, 
      ...
      describe 'Instance Methods' do
        ...
        describe "#form_tag" do 
          ...
          it "should return a basic form tag" do 
            ...
            _(html).must_have_tag('form#register-form[@action="/register"][@method=post]')
            _(html).wont_have_tag('input[@type=hidden]')
          end
          ...
          %w(put delete).each do |m| 
            ...
            it "should return a form tag with a faux method hidden tag when given a method => :#{m} " do 
              ...
              _(html).must_have_tag("form#register-form[@action='/register'][@method=post]")
              _(html).must_have_tag('form#register-form')

              _(html).must_have_tag(%Q{input[@type=hidden][@name="_method"][@value="#{m.upcase}"]})
            end
          ...
          %w(get post).each do |m|
            ...
            it "should NOT include a fauxmethod tag when given a method => :#{m} " do 
              html = tag_helpers_app("<% form_tag('/register', method: :#{m}, id: 'register-form' ) %>")
              _(html).must_have_tag("form#register-form[@action='/register'][@method=#{m}]")
              _(html).wont_have_tag('input[@type=hidden]')
            end
          ...
          [ 
            ...
            it "renders the form with :#{k} => #{v}" do 
              ...
              _(html).must_have_tag('form[@action="/register"][@method=post][@enctype="multipart/form-data"]')
            end
...
ERB
            ...
            # html.must_equal 'd'
            _(html).must_have_tag('form#register-form[@action="/register"][@method=post]')
            _(html).must_have_tag('form > p > label[@for=name]', 'Name:')
            _(html).must_have_tag('form > p > input[@name=name]')
          end
...
ERB
           html = tag_helpers_app(str)
           # _(html).must_equal ''
           _(html).must_have_tag('label[@for=name] > input[@type=checkbox][@class=checkbox][@id=name][@value="1"]')
          end
        ...
        describe "#hidden_field_tag" do 
          ...
          it "should render a hidden tag with custom value and id attributes" do 
            ...
            _(html).must_have_tag('input[@type=hidden]')
            _(html).must_have_tag('input[@type=hidden][id=snippet_name]')
            _(html).must_have_tag('input[@type=hidden][name=snippet_name]')
            _(html).must_have_tag('input[@type=hidden][value=myvalue]')
          end
        
          it "should render a hidden tag without value but with custom id attribute" do 
            _(tag_helpers_app("<%= hidden_field_tag(:snippet_name, :id => 'some-id') %>"))
          ...
          it "should render an empty hidden tag with default attributes" do 
            _(tag_helpers_app("<%= hidden_field_tag(:snippet_name) %>"))
          ...
          it "should remove the :id attribute when ':id => false'" do 
            _(tag_helpers_app("<%= hidden_field_tag(:snippet, :id => false ) %>"))
          ...
          it "should render an empty hidden tag when only one attribute is passed" do 
            _(tag_helpers_app("<%= hidden_field_tag(:snippet ) %>"))
        ...
        describe "#text_field_tag" do
          ...
          it "should render a basic textfield tag when only one attribute is passed" do
            ...
            _(html).must_equal(%Q{<input class="text" id="snippet_name" name="snippet_name" type="text">\n})
          end
          
          it "should render a textfield tag with a value" do
            html = tag_helpers_app("<%= text_field_tag(:snippet_name, value: 'some-value') %>")
            _(html).must_equal(%Q{<input class="text" id="snippet_name" name="snippet_name" type="text" value="some-value">\n})
            _(html).must_have_tag('input[@type=text][@class=text][@value="some-value"]')
            # _(html).must_have_tag('input[@type=text][@id=snippet_name][@name=snippet_name][@value="some-value"]')
          end
          ...
          it "should render a textfield tag with a custom id attribute" do
            ...
            _(html).must_have_tag('input[@type=text][@class=text][@name=snippet_name]')
          end

          it "should remove the :id attribute when 'id: false'" do
            html = tag_helpers_app("<%= text_field_tag(:snippet_name, id: false) %>")
            _(html).must_equal(%Q{<input class="text" name="snippet_name" type="text">\n})
            _(html).wont_have_tag('input[@type=text][@id]')
          end

          it "should render a textfield tag with a merged class attribute" do
            _(tag_helpers_app("<%= text_field_tag(:snippet_name, :class => :big ) %>"))
          ...
          it "should render a textfield with a :title attribute when :ui_hint / :title is passed" do
            ...
            _(html).must_have_tag('input[@type=text][@title="UI-HINT"]')
            _(html).must_have_tag('input[@type=text][@id=name][@name=name]')
          ...
          it "should render a textfield with a :size & :maxlength attributes when passed" do
            ...
            _(html).must_have_tag('input.text[@type=text][@maxlength="15"][@size="20"][@value="0.0.0.0"]')
            _(html).must_have_tag('input.text[@type=text][@id=ip][@name=ip]')
          end
          ...
          it "should render a textfield tag with content :disabled => true" do
            ...
            _(html).must_have_tag('input[@type=text][@disabled=disabled][@value="some-value"]')
            _(html).must_have_tag('input[@type=text][@id=snippet_name][@name=snippet_name]')
          end
          ...
          it "should render a readonly textfield tag when given :readonly => true" do
            ...
            _(html).must_have_tag('input[@type=text][@readonly=readonly]')
            _(html).must_have_tag('input[@type=text][@id=snippet_name][@name=snippet_name][@value="some-value"]')
          end
        ...
        describe "#password_field_tag" do
          ...
          it "should render a basic password field tag when only one attribute is passed" do
            ...
            _(html).must_equal %Q{<input class="text" id="snippet_name" name="snippet_name" type="password">\n}
          ...
          it "should render a password field tag with a value" do
            ...
            _(html).must_have_tag('input.text[@type=password][@class=text][@id=snippet_name][@name=snippet_name]')
          end
          ...
          it "should render a password field tag with a custom id attribute" do
            ...
            _(html).must_have_tag('input[@id="some-id"]')
            _(html).must_have_tag('input.text[@type=password][@class=text][@id="some-id"][@name=snippet_name]')
          end
          ...
          it "should render a password field tag with a merged class attribute" do
            ...
            _(html).must_have_tag('input.text[@type=password][@class="big text"][@id=snippet_name][@name=snippet_name]')
          end
          ...
          it "should render a password field with a :title attribute when :ui_hint is passed" do
            ...
            # _(html).must_equal('<input class="text" id="name" name="name" title="UI-HINT" type="password">')
            _(html).must_have_tag('input[@title="UI-HINT"]')
            _(html).must_have_tag('input.text[@type=password][@class=text][@id=name][@name=name]')
          end
        ...
        describe "#file_field_tag" do
          ...
          it "should render a basic file field tag when only one attribute is passed" do
            ...
            _(html).must_equal %Q{<input class="file" id="attachment" name="attachment" type="file">\n}
          ...
          it "should render a file field tag without the value attribute when passed" do
            ...
            _(html).must_equal(%Q{<input class="file" id="photo" name="photo" type="file">\n})
            _(html).wont_have_tag('input[@value]')
        ...
        describe "#textarea_tag" do
          ...
          it "should render a basic textarea tag when only one attribute is passed" do
            ...
            _(html).must_equal %Q{<textarea id="post" name="post"></textarea>\n}
            _(html).must_have_tag('textarea[@id=post]')
            _(html).must_have_tag('textarea[@name=post]')
          end

          it "should render a textarea tag with a value" do
            html = tag_helpers_app("<%= textarea_tag(:post, value: 'some-value') %>")
            _(html).must_have_tag('textarea#post',"some-value")
            _(html).wont_have_tag('textarea#post[@value=some-value]')
          end

          it "should render a textarea tag with a custom id attribute" do
            html = tag_helpers_app("<%= textarea_tag(:body, id: 'some-id') %>")
            _(html).must_have_tag('textarea[@id="some-id"]','')
            _(html).must_have_tag('textarea[@name=body]')
          end

          it "should render a textarea tag with a class attribute" do
            html = tag_helpers_app("<%= textarea_tag(:snippet, class: :big ) %>")
            _(html).must_have_tag('textarea[@class=big]','')
            _(html).must_have_tag('textarea[@id=snippet][@name=snippet]')
          end
          ...
          it "should render a textarea with a :title attribute when :ui_hint is passed" do
            ...
            _(html).must_have_tag('textarea[@title="UI-HINT"]','')
            _(html).must_have_tag('textarea[@id=name][@name=name]')
          end
          ...
          it "should render a textarea with a :cols & :rows attributes when passed" do
            ...
            _(html).must_have_tag('textarea[@rows="10"][@cols="25"]','')
            _(html).must_have_tag('textarea[@id=body][@name=body]')
            _(html).must_equal %Q{<textarea cols="25" id="body" name="body" rows="10"></textarea>\n}
          end
          ...
          it "should render a textarea with a :cols & :rows attributes when passed a :size attribute" do
            ...
            _(html).must_have_tag('textarea[@cols="15"][@rows="20"]','')
            _(html).must_have_tag('textarea[@id=body][@name=body]')
          end
          ...
          it "should render a textarea tag with content :disabled => true" do
            ...
            _(html).must_have_tag('textarea[@disabled=disabled]', 'Description goes here.')
            _(html).must_have_tag('textarea[@id=description][@name=description]')
          end
          ...
          it "should render a textarea tag with content :readonly => true" do
            ...
            _(html).must_have_tag('textarea[@readonly=readonly]', 'Description goes here.')
            _(html).must_have_tag('textarea[@id=description][@name=description]')
          end
...
ERB
           html = tag_helpers_app(str)
           _(html).must_have_tag('fieldset#fieldset-user-details > legend', 'User Details')
           _(html).must_have_tag('fieldset#fieldset-user-details > p > input#name[@type=text][@class=text][@id=name][@name=name]')
           # _(html).must_equal %Q{<fieldset id="fieldset-user-details">\n  <legend>User Details</legend>\n   <p><input class="text" id="name" name="name" type="text">\n</p></fieldset>\n}
          end
          ...
          it "should render a fieldset with class and legend" do
            ...
            _(html).must_have_tag('fieldset#fieldset-actor.legend-class > legend', 'User Details')
            _(html).must_have_tag('fieldset[@class=legend-class][@id=fieldset-actor] > legend', 'User Details')
          end
          ...
          it "should render a fieldset without :id when :id => false" do
            ...
            _(html).must_have_tag('fieldset > legend', 'User Details')
          ...
          it "should render a fieldset with :id attribute as 'fieldset' when passed nil as first args" do
            ...
            _(html).must_have_tag('fieldset.big > legend', 'User Details')
          end
...
ERB
        ...
        describe "#radio_button_tag" do
          ...
          it "should render tag with a value" do
            ...
            _(html).must_have_tag('input[@type=radio][@id="rock_rock-music"][@name=rock][@value="rock music"]')
          end

          it "should render tag with a custom id attribute" do
            html = tag_helpers_app("<%= radio_button_tag :rock, id: 'some-id' %>")
            _(html).must_have_tag('input.radio[@type=radio][@id="some-id_1"][@name=rock][@value="1"]')
          end

          it "should render tag with a merged class attribute" do
            _(tag_helpers_app("<%= radio_button_tag :rock, class: 'small' %>"))
          ...
          it "should render tag a :title attribute when :ui_hint is passed" do
            _(tag_helpers_app("<%= radio_button_tag :rock, ui_hint: 'UI-HINT' %>"))
        ...
        describe "#submit_tag" do
          ...
          it "should return a basic submit tag" do
            ...
            _(html).must_equal(%Q{<input name="submit" type="submit" value="Save Form">\n})
          ...
          it "should return a basic submit tag with custom value" do
            _(tag_helpers_app("<%= submit_tag('Custom Value') %>"))
          ...
          it "should return a basic submit tag with a custom class attribute" do
            ...
            _(html).must_have_tag('input[@type=submit][@class="some-class"][@value="Custom Value"]')
          ...
          it "should return a basic submit tag with disabled: true" do
            ...
            _(html).must_have_tag('input[@type=submit][@disabled=disabled][@name=submit][@value="Save Form"]')
          end
        ...
        describe "#select_tag" do
          ...
          it "should render a basic select tag from a Hash" do
            ...
            # _(html).must_equal ""
            _(html).must_have_tag('select#letters[@name=letters] > option[@value=a]','A')
            _(html).must_have_tag('select#letters[@name=letters] > option[@value=b]','B')
          end
          ...
          it "should render tag with the selected value" do
            ...
            _(html).must_have_tag('select#letters[@name=letters] > option[@value=a][@selected=selected]', 'A')
            _(html).must_have_tag('select#letters[@name=letters] > option[@value=b]', 'B')
          end

          it "should render tag with multiple selected values" do
            html = tag_helpers_app("<%= select_tag(:letters, [[:a, 'A'], [:b, 'B']], selected: [:a,'b'] ) %>")
            _(html).must_have_tag('select#letters[@name="letters[]"][@multiple=multiple]')
            _(html).must_have_tag('select#letters > option[@value=a][@selected=selected]', 'A')
            _(html).must_have_tag('select#letters > option[@value=b][@selected=selected]', 'B')
          end

          it "should render tag with :multiple => true" do
            html = tag_helpers_app("<%= select_tag(:letters, [[:a, 'A'], [:b, 'B']], multiple: true) %>")
            _(html).must_have_tag('select#letters[@name="letters[]"][@multiple=multiple]')
            _(html).must_have_tag('select#letters > option[@value=a]', 'A')
            _(html).must_have_tag('select#letters > option[@value=b]', 'B')
          end

          it "should render tag with :disabled => true" do
            html = tag_helpers_app("<%= select_tag(:letters, [[:a, 'A'], [:b, 'B']], disabled: true ) %>")
            _(html).must_have_tag('select#letters[@name=letters][@disabled=disabled]')
            _(html).must_have_tag('select#letters > option[@value=a]', 'A')
            _(html).must_have_tag('select#letters > option[@value=b]', 'B')
          end
          ...
          it "should render tag with a custom id" do
            ...
            _(html).must_have_tag('select#my-letters[@name=letters]')
            _(html).must_have_tag('select#my-letters > option[@value=a]', 'A')
            _(html).must_have_tag('select#my-letters > option[@value=b]', 'B')
          end

          it "should render tag with a custom class" do
            html = tag_helpers_app("<%= select_tag(:letters, [[:a, 'A'], [:b, 'B']], class: 'funky-select') %>")
            _(html).must_have_tag('select#letters[@name=letters][@class="funky-select"]')
            _(html).must_have_tag('select#letters > option[@value=a]', 'A')
            _(html).must_have_tag('select#letters > option[@value=b]', 'B')
          end
          ...
          it "should render tag with prompt => true" do
            ...
            _(html).must_have_tag('select#letters[@name=letters]')
            _(html).must_have_tag('select#letters > option[@value=""][@selected=selected]', '- Select -')
            _(html).must_have_tag('select#letters > option[@value=a]', 'A')
            _(html).must_have_tag('select#letters > option[@value=b]', 'B')
          end
          ...
          it "should render tag with a custom prompt" do
            ...
            _(html).must_have_tag('select#letters[@name=letters]')
            _(html).must_have_tag('select#letters > option[@value=""]', 'My Favourite Letters')
            _(html).must_have_tag('select#letters > option[@value=a][@selected=selected]', 'A')
            _(html).must_have_tag('select#letters > option[@value=b]', 'B')
          end
        ...
        describe 'private' do          
          ...
          describe '#html_safe_id' do
            ...
            it "should return a safe id from 'snippet_name'" do
              _(tag_helpers_app('<%= self.send(:html_safe_id, "snippet_name") %>')).must_equal 'snippet_name'
            end
            
            it "should return a safe id from 'snippet name'" do
              _(tag_helpers_app('<%= self.send(:html_safe_id, "snippet name") %>')).must_equal 'snippet-name'
            end
            
            it "should return a safe id from 'SnippetName'" do
              _(tag_helpers_app('<%= self.send(:html_safe_id, "SnippetName") %>')).must_equal 'snippetname'
            end
            
            it "should return a safe id from 'Snippet::Category'" do
              _(tag_helpers_app('<%= self.send(:html_safe_id, "Snippet::Category") %>')).must_equal 'snippet-category'
            end
          ...
          describe '#add_css_class' do
            ...
            it "should return the combined classes" do
              _(tag_helpers_app('<%= self.send(:add_css_class, { class: ["alert"]}, ["alert-info"]) %>')).must_equal '{:class=>"alert alert-info"}'
            end
            
            it "should handle no {:class} and nil values being passed in" do
              _(tag_helpers_app('<%= self.send(:add_css_class, {id: :idval}, nil) %>')).must_equal '{:id=>:idval, :class=>nil}'
              _(tag_helpers_app('<%= self.send(:add_css_class, {}, nil) %>')).must_equal '{:class=>nil}'
              _(tag_helpers_app('<%= self.send(:add_css_class, {}, "") %>')).must_equal '{:class=>nil}'
            end
            
            it "should handle no {:class} being passed in" do
              _(tag_helpers_app('<%= self.send(:add_css_class, {}, ["alert-info"]) %>')).must_equal '{:class=>"alert-info"}'
            end
            
            it 'should order classes alphabetically' do
              _(tag_helpers_app('<%= self.send(:add_css_class, { class: "a c d"}, [:e, :b]) %>')).must_equal '{:class=>"a b c d e"}'
            end
            
            it 'should handle duplicate class values' do
              _(tag_helpers_app('<%= self.send(:add_css_class, { class: "alert text"}, [:alert, "alert-info"]) %>')).must_equal '{:class=>"alert alert-info text"}'
            end
            
            it 'should handle other attr values' do
              _(tag_helpers_app('<%= self.send(:add_css_class, { class: "text", id: :idval}, [:alert]) %>')).must_equal '{:class=>"alert text", :id=>:idval}'
            end
            ...
            it 'should handle combining strings being passed' do
              _(tag_helpers_app('<%= self.send(:add_css_class, { class: "big"}, "text") %>')).must_equal '{:class=>"big text"}'
            end
            ...
            it 'should handle combining strings being passed' do
              _(tag_helpers_app('<% attrs = {id: :idval, class: :big} %><% attrs = self.send(:add_css_class, attrs, :text) %><%= attrs %>')).must_equal '{:id=>:idval, :class=>"big text"}'
            end
          ...
          describe '#add_css_id' do
            ...
            it "should handle {} and nil values being passed in" do
              _(tag_helpers_app('<%= self.send(:add_css_id, nil, nil) %>')).must_equal '{:id=>nil}'
              _(tag_helpers_app('<%= self.send(:add_css_id, {}, nil) %>')).must_equal '{:id=>nil}'
              _(tag_helpers_app('<%= self.send(:add_css_id, nil, {}) %>')).must_equal '{:id=>nil}'
              _(tag_helpers_app('<%= self.send(:add_css_id, {}, "") %>')).must_equal '{:id=>nil}'
            end
            
            it "should handle {} and nil values being passed in with an id" do
              _(tag_helpers_app('<%= self.send(:add_css_id, nil, :idval) %>')).must_equal '{:id=>"idval"}'
              _(tag_helpers_app('<%= self.send(:add_css_id, nil, "idval") %>')).must_equal '{:id=>"idval"}'
              _(tag_helpers_app('<%= self.send(:add_css_id, {}, :idval) %>')).must_equal '{:id=>"idval"}'
              _(tag_helpers_app('<%= self.send(:add_css_id, {}, "idval") %>')).must_equal '{:id=>"idval"}'
            end
            
            it "should handle values being passed in correctly" do
              _(tag_helpers_app('<%= self.send(:add_css_id, {}, :name) %>')).must_equal    '{:id=>"name"}'
            end
            
            it "should retain and not overwrite the { :id } value passed in" do
              _(tag_helpers_app('<%= self.send(:add_css_id, {id: :snippet }, :name) %>')).must_equal    '{:id=>"snippet"}'
            end
